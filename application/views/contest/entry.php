...
<html>
	...
	<body>
		...
		<form action="/kohana/contest/details" method="post">
			...
			<label for="email"><?php echo __('Email Address'); ?></label><br /><input id="email" name="email" type="text" placeholder="<?php echo 'Enter Email Here...'; ?>" value="<?php if (isset($email)) { echo $email; } ?>" /><br />
			<span class="error"><?php if (isset($errors)) { echo $errors; } ?></span>
